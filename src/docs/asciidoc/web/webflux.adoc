...
----
	@Configuration
	@EnableWebFlux
	class beanfactorypostprocessor.MyConfig implements WebFluxConfigurer {
...
----
	@Configuration
	@EnableWebFlux
	class beanfactorypostprocessor.MyConfig : WebFluxConfigurer {
...
----
	@Configuration
	public class beanfactorypostprocessor.MyConfig {
...
----
	@Configuration
	class beanfactorypostprocessor.MyConfig {
